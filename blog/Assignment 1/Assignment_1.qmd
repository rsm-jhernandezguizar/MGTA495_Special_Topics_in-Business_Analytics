...
I ran a series of Welch’s t-tests comparing donation rates across match ratio groups (1:1, 2:1, and 3:1). Here’s what we learned:

Comparison	Difference in Means	T-statistic	P-value	Stat. Sig.?
2:1 vs 1:1	+0.0019	0.9650	0.3345	❌ No
3:1 vs 1:1	+0.0020	1.0150	0.3101	❌ No
2:1 vs 3:1	–0.0001	–0.0501	0.9600	❌ No

	•	Interpretation: None of the comparisons show statistically significant differences. The p-values are all much higher than 0.05, so we fail to reject the null hypothesis in each case.
	•	Means are very close: Around 2.07%–2.27% donation rates—tiny differences that are not meaningful in practice or statistical significance.

On page 8 of the original paper (Table 2A, Panel A), Karlan and List state:

“Larger match ratios ($3:$1 and $2:$1) relative to a smaller match ratio ($1:$1) had no additional impact.”

✔️ My findings directly support this conclusion. The statistical evidence from your t-tests aligns with theirs: increasing the match ratio doesn’t significantly increase the likelihood of donating.

This suggests that, while having a match at all helps (compared to no match), larger matches do not continue to increase response rates. So, from a fundraising strategy perspective, offering a simple 1:1 match is just as effective as offering a more generous match—and much cheaper for the matching donor 😅.
